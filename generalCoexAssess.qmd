...
table.tot.neural$AbsVal <- abs(table.tot.neural$value)
table.tot.neural$LogAbsVal <- log(table.tot.neural$AbsVal+0.001)
ggbetweenstats(
  data = table.tot.neural[!table.tot.neural$Method == "Seurat SCT corr.",],type = "robust", 
  x = Method,
  y = LogAbsVal
)
```
...
```{r, echo=FALSE, eval=FALSE}
ggbetweenstats(
  data = table.tot.neural[!table.tot.neural$Method == "Seurat corr.",],type = "robust", 
  x = Method,
  y = AbsVal
)
```
...
```{r, echo=FALSE, eval=FALSE}
table.tot.hk$LogAbsVal <- log(abs(table.tot.hk$value)+0.001)

ggbetweenstats(
  data = table.tot.hk[!table.tot.hk$Method == "Seurat corr.",],type = "robust", 
  x = Method,
  y = LogAbsVal
)
```
