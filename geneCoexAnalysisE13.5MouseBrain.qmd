...
```{r, echo=FALSE}
pvalueMat.big <- calculatePValue(obj, geneSubsetCol = c(genesList$NPGs,genesList$hk,genesList$PNGs,genesList$layers),geneSubsetRow = c(genesList$NPGs,genesList$hk,genesList$PNGs,genesList$layers))
...
saveRDS(seurat.data.cor.big,file = paste0("CoexData/SeuratCorr_",
                              ...
                              ".RDS"))
saveRDS(p_values ,file = paste0("CoexData/SeuratPValues_",
                              getMetadataElement(obj, datasetTags()[["cond"]]),
                              ".RDS"))
```
...
saveRDS(p_values ,file = paste0("CoexData/SeuratPValuesSCT_",
                              getMetadataElement(obj, datasetTags()[["cond"]]),
                              ".RDS"))
```
