...
def scanpyFDR(exprs, meta, feature_meta,  mtCode, outDir, sample, genes_of_interest):
  
  # genes_of_interest = r.int_genes
  # exprs = r.exprs
  # meta = r.meta
  ...
  # })
  #   
  expression_matrix.to_csv(outDir+sample+"_Scanpy_expression_all_genes.gz")
